...
(function() {
	...
	// disable after test
	var heartRateList = [0,90,110,130,150,0,90,110,130,150,170];
...
//            	tizen.humanactivitymonitor.start('HRM', onsuccessCB);
                ...
                if (heartRateCounter >= 10){
                	heartRateCounter = 0;
                } else {
                	heartRateCounter += 1;
                }
                heartRate = heartRateList[heartRateCounter];
                
        		if (heartRate >= lowerHeartThreshold && heartRate <= upperHeartThreshold) {
        			state = 0;
        			console.log("State: "+state + " "+ heartRate);
        		} else {
        			state = 1;
        			console.log("State: "+state + " "+ heartRate);
        		}
                ...
                console.log(heartRate + " heartratecounter: "+heartRateCounter);
             // DELETE WHEN TEST IS FINISHED
            }
        });
    }
